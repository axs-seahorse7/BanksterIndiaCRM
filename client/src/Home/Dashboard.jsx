        ...
        <div className='flex'>
            <section className='w-[200px] border border-slate-200 h-screen shadow relative'>
                ...
                <div className='w-full pt-4 px-0.5 gap-1 flex flex-col'>
                    ...
                    <div onClick={()=> setPage('client')} className={`${Page === 'client'? 'text-cyan-500 bg-slate-200' : "text-slate-500"}  w-full border-sate-200 font-semibold cursor-pointer pl-4 hover:bg-slate-200 active:bg-slate-300 active:text-gray-700 py-2 select-none flex gap-4 `}><span><i className="ri-building-line"></i></span> <span>Clients</span></div>

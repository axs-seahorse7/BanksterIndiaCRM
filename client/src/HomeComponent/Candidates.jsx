...
import { Popover, Button, Checkbox, Drawer, Descriptions , Card, Avatar } from "antd";
...
const Candidates = ({openForm, filter}) => {
    ...
    console.log("candidates : ", candidateLendth)
  ...
  <div className='w-full flex flex-col bg-white shadow-md py-4 rounded'>
      ...
      <div className='mt-8 rounded px-4 '>
          ...
          key={i} 
          className='text-gray-500 justify-around flex pr-10 pl-4 gap-6 cursor-pointer bg-white py-2   border-b border-r border-l border-slate-300'
          >
            ...
            <span className='w-16 flex gap-2'>Active </span>            
